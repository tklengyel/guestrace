...
int            gt_guest_get_page_size(GtGuestState *state, gt_addr_t vaddr, gt_pid_t pid);
...
gt_pid_t       gt_guest_get_parent_pid(GtGuestState *state, gt_pid_t pid, gboolean *is_userspace);
void           gt_guest_hijack_return(GtGuestState *state, reg_t retval);
void           gt_guest_drop_return_breakpoint(GtGuestState *state);
void           gt_guest_clear_return_state(GtGuestState *state);
